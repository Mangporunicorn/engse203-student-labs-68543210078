...
| **TC-L5-17** | กดปุ่ม Reset Demo Data → ยืนยัน | ข้อมูลตัวอย่างกลับมาครบ · ตัวกรองรีเซ็ตเป็น all · **ข้อมูลของเว็บอื่นในโดเมนเดียวกันไม่ถูกลบ** | เมื่อยืนยัน Reset Demo Data ข้อมูลกลับเป็นชุดตัวอย่าง ตัวกรองกลับเป็น all และ refresh แล้วยังคงเป็นข้อมูลชุดตัวอย่าง
สถานะ: PASS | PASS | |
